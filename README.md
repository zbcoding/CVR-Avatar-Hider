Archive only, unless there's a feature to add in the future. ChilloutVR developers already added basic avatar hiding for far-away avatars in the base game.
